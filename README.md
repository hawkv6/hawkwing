# HawkWing
> Leveraging eBPF for Intent-Driven Application-Based End-to-End Segment Routing over IPv6

## Overview
HawkWing is a prototype implementation of Intent-Driven Application-Based End-to-End Segment Routing over IPv6. It leverages eBPF to implement the data plane of the prototype. The control plane is implemented in Golang. 
